...
**Atenção**: As funções devem ser projetadas e conter todos os elementos do processo que vimos em sala.

#. Projete uma função que encontre o máximo entre dois números dados.

#. [sicp 1.3] Projete uma função que receba $3$ números como parâmetros e retorne a soma dos quadrados dos dois maiores números.
