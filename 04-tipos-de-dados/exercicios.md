...
@) Qual é o nome da função que utilizamos para criar uma instância de estrutura?

@) Qual é o nome das funções que utilizamos para obter o valor de um campo de uma instância de uma estrutura?
...
@) De que forma enumerações como entradas para funções guiam a criação dos exemplos e da implementação?
